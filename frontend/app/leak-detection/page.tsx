...
`;
  ...
  return (
    <div className="space-y-6">
      ...
      <section
        aria-labelledby="research-prototype-heading"
        className="rounded-2xl border border-amber-300 bg-amber-500/10 p-4 text-amber-950 dark:border-amber-700/60 dark:bg-amber-950/40 dark:text-amber-200"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1 text-xs leading-relaxed font-semibold">
            <h3
              id="research-prototype-heading"
              className="text-sm font-black text-amber-950 dark:text-amber-100"
            >
              Demonstration & Research Prototype Mode
            </h3>
