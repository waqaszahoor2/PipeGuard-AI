...
interface ModelInformationViewProps {
  initialEvaluation: EvaluationArtifact | null;
  initialError: string | null;
}

export function ModelInformationView({ initialEvaluation, initialError }: ModelInformationViewProps) {
  const [data, setData] = useState<EvaluationArtifact | null>(initialEvaluation);
  const [loading, setLoading] = useState(!initialEvaluation && !initialError);
    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-rose-300 bg-rose-500/10 p-5 text-rose-950 dark:border-rose-900/60 dark:bg-rose-950/40 dark:text-rose-200">
        <div className="flex items-start gap-4">
          ...
          <div className="text-xs leading-relaxed font-semibold space-y-2">
            <h3 className="text-sm font-black block">MODEL STATUS: RESEARCH PROTOTYPE / NOT APPROVED FOR OPERATIONAL USE</h3>
            <p>
        ...
        <>
          ...
          <section className="card p-6 space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-3 pt-2">
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/50 space-y-1">
                <h4 className="text-xs font-extrabold text-blue-600 dark:text-cyan-300">1. Event Grouping</h4>
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/50 space-y-1">
                <h4 className="text-xs font-extrabold text-blue-600 dark:text-cyan-300">2. Buffer Gaps</h4>
                <p className="text-xs text-slate-600 dark:text-slate-300">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/50 space-y-1">
                <h4 className="text-xs font-extrabold text-blue-600 dark:text-cyan-300">3. Class Balance Check</h4>
                <p className="text-xs text-slate-600 dark:text-slate-300">
          ...
          <section className="grid gap-6 md:grid-cols-2">
            <div className="card p-6 border-emerald-200 dark:border-emerald-900/60 space-y-3">
              <div className="flex items-center gap-2 text-emerald-700 dark:text-emerald-400 font-extrabold text-sm">
                <CheckCircle2 className="h-5 w-5" />
                <h3>Intended & Permitted Uses</h3>
              </div>
            ...
            <div className="card p-6 border-rose-200 dark:border-rose-900/60 space-y-3">
              <div className="flex items-center gap-2 text-rose-700 dark:text-rose-400 font-extrabold text-sm">
                <ShieldAlert className="h-5 w-5" />
                <h3>Explicitly Prohibited Uses</h3>
              </div>
              <ul className="space-y-2 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
